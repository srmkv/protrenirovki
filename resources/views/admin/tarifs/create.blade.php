                ...
                <form action="{{route('tarifs.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="intro-y box p-5">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="crud-form-status_10" name="status_10" type="text" class="form-control">
                        </div>
