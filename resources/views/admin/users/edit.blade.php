                ...
                <form action="{{route('users.update', $user->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="intro-y box p-5">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="crud-form-name" name="name" value="{{$user->name}}" type="text"
                        ...
                        <div class="mt-3">
                            ...
                            <input id="crud-form-email" name="email" type="email" class="form-control"
                                   data-single-mode="true" value="{{$user->email}}"
                        ...
                        <div class="mt-3">
                            ...
                            <input id="crud-form-traffic" name="traffic" type="text" class="form-control"
                                   data-single-mode="true" value="{{$user->traffic}}"
                                   placeholder="{{__('messages.traffic')}} ">
                        </div>
