                ...
                <form action="{{route('trainers.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="intro-y box p-5">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="crud-form-name" name="name" type="text" class="form-control w-full" placeholder="{{__('messages.name')}} ">
                        </div>
                        <div class="mt-3">
                            <label for="crud-form-surname" class="form-label">{{__('messages.surname')}} </label>
                            <input id="crud-form-surname" name="surname" type="text" class="form-control" data-single-mode="true" placeholder="{{__('messages.surname')}} ">
                        </div>
                        <div class="mt-3">
                            <label for="crud-form-education" class="form-label">{{__('messages.education')}} </label>
                            <textarea name="education" id="editortrainer"></textarea>
                        </div>
                        <div class="mt-3">
                            <label for="crud-form-achievements" class="form-label">{{__('messages.achievements')}} </label>
                            <textarea name="achievements" id="editorachievements"></textarea>
                        </div>
                        ...
                        <div class="text-right mt-5">
                            <a href="{{route('trainers.index')}}" class="btn btn-danger w-24">{{__('messages.cancel')}}</a>
